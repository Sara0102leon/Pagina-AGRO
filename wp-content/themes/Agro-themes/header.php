...
<body class="bg-base text-white font-sans antialiased selection:bg-agro-green selection:text-base transition-colors duration-300">
    ...
    <header class="sticky top-0 z-50 bg-base/95 shadow-md backdrop-blur-sm transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="logo">
                <a href="#" class="block">
                    <!-- Logo horizontal apto para fondo oscuro -->
    ...
    <div id="sidebar-menu" class="fixed inset-0 z-[100] translate-x-full transition-transform duration-300 ease-in-out lg:hidden">
        <!-- Fondo oscuro semitransparente detrás del menú -->
        <div id="sidebar-overlay" class="absolute inset-0 bg-black/60 backdrop-blur-sm opacity-0 transition-opacity duration-300 pointer-events-none"></div>
        
        <nav class="absolute top-0 right-0 w-72 h-full bg-card shadow-2xl p-6 flex flex-col justify-between z-10">
            <div>
    ...
    <!-- SCRIPT DE CONTROL PARA EL MENÚ RESPONSIVO -->
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Cerrar automáticamente si hacen click en una sección (ancla)
            links.forEach(link => {
